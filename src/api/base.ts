...
export class BaseAPI {
  ...
  protected async fetch(
    ...
    const result = await fetch(url, {
      credentials:
        options.credentials ||
        this.requestOptions?.credentials ||
        "same-origin",
      ...
      referrerPolicy:
        options.referrerPolicy || this.requestOptions?.referrerPolicy,
...
type QueryParams = Record<
  string,
  string | string[] | Date | Date[] | boolean | number | undefined
>;
type QueryOptions = Record<
  string,
  { explode?: boolean; delimiter?: "," | " " | "|"; format?: "date" }
>;
